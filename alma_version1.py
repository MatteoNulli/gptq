...
def get_alma(model):
    ...
    model = AutoModelForCausalLM.from_pretrained(f"{args.model}", torch_dtype=torch.float16, device_map="auto")
...
def alma_sequential(model, dataloader, dev):
    ...
    # print('model.model.embed_tokens', model.model.model.embed_tokens)
